...
bot.command("ciao", (ctx) => ctx.reply("Ecco",zionTelegraf.createReplyMarkupKeyboard([[{text:"prova"}]])) )

bot.command("test", (ctx) => ctx.reply("2",zionTelegraf.createReplyMarkupKeyboard([[{text:"prova2"}]])) )
