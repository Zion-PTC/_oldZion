...
export declare class Combinations<T> implements ICombinations<T> {
    layers: T[][];
    layers_by_rarity: T[][][];
    combinaTuttiElementiResult?: T[][] | undefined;
    combinaElementiPerRaritaResult?: T[][][] | undefined;
    combinaElementiPerRaritaResultFlatten?: T[][] | undefined;
    calcolaPercentualePerRaritaResult: string[][];
    calcolaPercentualePerTuttiResult: string[][];
    get totalPossibleCombinations_by_Rarity(): T[];
    get totalPossibleCombinations(): ITotalPossibleCombinations;
    get numberOfPossibleCombinations(): number;
    get numberOfPossibleCombinations_by_rarity(): number;
    constructor(layers?: T[][], layers_by_rarity?: T[][][], combinaTuttiElementiResult?: T[][] | undefined, combinaElementiPerRaritaResult?: T[][][] | undefined, combinaElementiPerRaritaResultFlatten?: T[][] | undefined, calcolaPercentualePerRaritaResult?: string[][], calcolaPercentualePerTuttiResult?: string[][]);
    ...
    calcolaPercentuale: <T_1>(el: T_1, layer: number, poss: T_1[][] | undefined, calcolaPercentualeResult: [[T_1, string]]) => [[T_1, string]];
