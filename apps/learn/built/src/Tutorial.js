...
var Tutorial_1;
import { decorator, factory, abstractFactory, facade, } from "./DesignPattern.js";
...
export class ATutorial {
    ...
    static mostraTutorials() {
        let array = {};
        function aggiunginome(tutorial) {
...
let Tutorial = Tutorial_1 = class Tutorial extends ATutorial {
    constructor() {
        super();
        Tutorial_1.tutorials.push(this);
    }
...
export { Tutorial };
const decTut1URL = "https://www.dofactory.com/javascript/design-patterns/decorator";
...
const decTut3URL1 = "https://dev.to/carlillo/understanding-design-patterns-decorator-using-long-night-got-example-276c";
...
const decTut2URL = "https://dev.to/carlillo/understanding-design-patterns-decorator-using-long-night-got-example-276c";
const decTut2GitHub = "https://github.com/Caballerog/blog/tree/master/adapter-pattern";
...
const TSGenericsPath = "https://www.typescriptlang.org/docs/handbook/2/generics.html";
export let TSGenerics = new Tutorial();
TSGenerics.titolo = "Generics";
TSGenerics.links = [TSGenericsPath];
const factoryTutorialPath = "https://www.dofactory.com/javascript/design-patterns/factory-method";
...
//// ABSTRACT FACTORY
const abstractFactory1Path = "https://www.dofactory.com/javascript/design-patterns/abstract-factory";
...
const abstractFactory2Path = "https://www.digitalocean.com/community/tutorials/js-factory-pattern";
...
const facade1Path = "https://www.dofactory.com/javascript/design-patterns/facade";
...
const sshKeysPath1 = "https://docs.github.com/en/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys";
const sshKeysPath2 = "https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent";
const sshKeysPath3 = "https://www.man7.org/linux/man-pages/man1/ssh-keygen.1.html";
const sshKeysPath4 = "https://www.techrepublic.com/article/how-to-view-your-ssh-keys-in-linux-macos-and-windows/";
let sshKeys = new Tutorial();
sshKeys.titolo = "ssh";
sshKeys.links = [sshKeysPath1, sshKeysPath2, sshKeysPath3, sshKeysPath4];
const secureFilesInOsxPath = "https://www.groovypost.com/howto/securely-delete-files-mac/";
...
const dockerMultiPlatformBuildsPath1 = "https://www.docker.com/blog/multi-platform-docker-builds/";
const dockerMultiPlatformBuildsPath2 = "https://developer.arm.com/documentation/102475/0100/Multi-architecture-images";
...
const gitLoginPath = "https://docs.github.com/en/get-started/getting-started-with-git/setting-your-username-in-git";
let gitLogin = new Tutorial();
gitLogin.titolo = "Settin user name in git";
gitLogin.links = [gitLoginPath];
const graphNodesClassificationwAIPath = "https://docs.dgl.ai/tutorials/blitz/2_dglgraph.html";
...
const kubernetesWContainerDPath = "https://getbetterdevops.io/replace-docker-on-your-raspberry-pi-with-containerd/";
...
const graphInJSPath = "https://adrianmejia.com/data-structures-for-beginners-graphs-time-complexity-tutorial/";
let graphInJS = new Tutorial();
graphInJS.titolo =
    "Data structures for beginners graphs time complexity tutorial";
graphInJS.links = [graphInJSPath];
const visualizeGraphsPath = "https://blog.dataiku.com/building-a-graph-visualization-tool";
...
const k8sIngressPath = "https://thenewstack.io/kubernetes-ingress-for-beginners/";
let k8sIngress = new Tutorial();
k8sIngress.titolo = "Kubernetes ingress for beginners";
k8sIngress.links = [k8sIngressPath];
const k8sIngressExternalAccessPath = "https://kubebyexample.com/en/learning-paths/application-development-kubernetes/lesson-3-networking-kubernetes/exposing-0";
...
const raspK8sCloudflarePath = "https://itnext.io/building-a-kubernetes-cluster-on-raspberry-pi-and-low-end-equipment-part-2-33f21695251c";
...
const nextJSFirstStepsPath = "https://nextjs.org/learn/foundations/how-nextjs-works/compiling";
...
const youtubeNodeUploadPath = "https://quanticdev.com/articles/automating-my-youtube-uploads-using-nodejs/";
