...
decTut3.links = [
    new URL('https://dev.to/carlillo/understanding-design-patterns-decorator-using-long-night-got-example-276c'),
...
decTut2.github = new URL('https://github.com/Caballerog/blog/tree/master/adapter-pattern');
...
factoryTutorial.links = [
    new URL('https://www.dofactory.com/javascript/design-patterns/factory-method'),
];
...
abstractFactory1.links = [
    new URL('https://www.dofactory.com/javascript/design-patterns/abstract-factory'),
];
...
abstractFactory2.links = [
    new URL('https://www.digitalocean.com/community/tutorials/js-factory-pattern'),
];
