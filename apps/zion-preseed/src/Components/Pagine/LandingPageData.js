...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
export let businessModelData = {
  businessWrapper: {
    id: 'business',
  },
  page: {
    id: 'business-model-page',
    dynamic: css``,
  },
  titolo: {
    tipo: 2,
  ...
  background: {
    overFlowArea: {
      id: 'business-background-overflow-area',
      dynamic: css`
        grid-area: a;
      `,
    },
...
export let tokenomicsData = {
  ...
  chart1: {
    data: {
      labels: ['Creators', 'Team', 'DAO/Community', 'Investors'],
      datasets: [
        {
