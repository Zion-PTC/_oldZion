...
const bmd = new BMDatas(
  {
    tipo: 2,
    children: "Business Model",
    div: { id: "solution2-titolo", dynamic: bmCss },
    sottoTitolo: undefined,
    type: "business",
  },
  bmChart,
  {
    overFlowArea: { id: ovFlId, dynamic: ovCss },
    filter: { id: "filter", dynamic: filCss },
    img: { src: tickets, alt: tag, id: tag, dynamic: imgCss },
  }
);
