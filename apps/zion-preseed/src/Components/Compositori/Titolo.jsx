...
let Barra2 = styled.div`
    background-color: ${MID};
    width: 20%;
    margin-right: 10px;
  `

let Barra3 = styled.div`
...
export default function Titolo({
  ...
  let Titolo2 = <AreaTitolo2 id="titolo-tipo2">
    <Barra2 id="barra2" barraColor={barraColor}></Barra2>
    <Testo id="testo" color={color}>{children}</Testo>
  </AreaTitolo2>

  let Titolo3 = <AreaTitolo2 id="titolo-tipo3">
    <Barra3 id="barra3" barraColor={barraColor}></Barra3>
    <div>
      <Testo id="testo" color={color}>{children}</Testo>
      <TestoSmall id="testoSmall" color={color}>{sottoTitolo}</TestoSmall>
    </div>
  </AreaTitolo2>
