...
let generatePhoneObj = (brand, model, width, height) => {
...
let generateTabletObj = (brand, model, width, height) => {
...
export let calculateYouTubeResponsiveValues = (h) => {
  let YTW = 560
  let YTH = 315
