...
type MixinDecoratorTypeAny = (mixin: any) => any;
type MixinDecoratorTypeMixinAny = (mixin: MixinAny) => {};
...
export const BaseMixin: MixinDecoratorTypeMixinAny = (mixin: any) =>
...
export const Cached: MixinDecoratorTypeAny = (mixin) =>
  wrap(mixin, (superclass: any) => {
...
export const DeDupe: MixinDecoratorTypeAny = (mixin) =>
  wrap(mixin, (superclass: any) =>
