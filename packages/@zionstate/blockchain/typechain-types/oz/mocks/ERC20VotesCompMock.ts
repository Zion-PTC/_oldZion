...
export interface ERC20VotesCompMockInterface extends utils.Interface {
  functions: {
...
export interface ERC20VotesCompMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20VotesCompMockInterface;
