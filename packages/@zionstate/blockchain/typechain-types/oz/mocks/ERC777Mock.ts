...
export interface ERC777MockInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "mintInternalExtended",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
...
export interface BeforeTokenTransferEventObject {}
export type BeforeTokenTransferEvent = TypedEvent<
  [],
  BeforeTokenTransferEventObject
>;
...
export interface ERC777Mock extends BaseContract {
  ...
  functions: {
    ...
    mintInternalExtended(
      ...
      userData: PromiseOrValue<BytesLike>,
      operatorData: PromiseOrValue<BytesLike>,
      requireReceptionAck: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
