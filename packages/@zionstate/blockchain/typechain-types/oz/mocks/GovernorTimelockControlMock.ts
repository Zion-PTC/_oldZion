...
export interface GovernorTimelockControlMockInterface extends utils.Interface {
  functions: {
...
export interface GovernorTimelockControlMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorTimelockControlMockInterface;
