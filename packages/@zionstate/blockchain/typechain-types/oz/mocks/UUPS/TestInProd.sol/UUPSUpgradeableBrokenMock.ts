...
export interface UUPSUpgradeableBrokenMockInterface extends utils.Interface {
  functions: {
...
export interface UUPSUpgradeableBrokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UUPSUpgradeableBrokenMockInterface;
