...
export interface MulticallTokenMockInterface extends utils.Interface {
  functions: {
...
export interface MulticallTokenMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MulticallTokenMockInterface;
