...
export interface BalanceOfEventObject {
  token: string;
  account: string;
  value: BigNumber;
}
export type BalanceOfEvent = TypedEvent<
  [string, string, BigNumber],
  BalanceOfEventObject
>;

export type BalanceOfEventFilter = TypedEventFilter<BalanceOfEvent>;

export interface TotalSupplyEventObject {
  token: string;
  value: BigNumber;
}
export type TotalSupplyEvent = TypedEvent<
  [string, BigNumber],
  TotalSupplyEventObject
>;

export type TotalSupplyEventFilter = TypedEventFilter<TotalSupplyEvent>;
