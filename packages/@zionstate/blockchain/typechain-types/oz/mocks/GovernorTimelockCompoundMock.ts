...
export interface GovernorTimelockCompoundMockInterface extends utils.Interface {
  functions: {
...
export interface GovernorTimelockCompoundMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorTimelockCompoundMockInterface;
