...
export interface ConditionalEscrowMockInterface extends utils.Interface {
  functions: {
...
export interface ConditionalEscrowMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConditionalEscrowMockInterface;
