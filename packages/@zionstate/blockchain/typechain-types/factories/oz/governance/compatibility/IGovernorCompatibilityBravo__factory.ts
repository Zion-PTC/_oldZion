...
} from "../../../../oz/governance/compatibility/IGovernorCompatibilityBravo";
...
export class IGovernorCompatibilityBravo__factory {
  ...
  static createInterface(): IGovernorCompatibilityBravoInterface {
    return new utils.Interface(_abi) as IGovernorCompatibilityBravoInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IGovernorCompatibilityBravo;
  }
}
