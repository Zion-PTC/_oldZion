export declare type DataType = DataType1 & DataType2;
export declare type DataType1 = {
    [k: string]: unknown;
};
/**
...
export interface DataType2 {
    ...
    } | PackageExportsEntryObject | PackageExportsEntry[];
    bin?: string | {
        [k: string]: string;
    };
    /**
